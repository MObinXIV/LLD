...
without annoying the clients with my own shits , when we change the code every time 
*/
...
//     }
// };
// now client free to only ask for his chosen vehicle
int main()
{
    string type;
    ...
    Vehicle*v= vehicleFactory::getVehicle(type); // Get the benefit of static defintion & get a Vehicle type from the class
    v->createVehicle();
